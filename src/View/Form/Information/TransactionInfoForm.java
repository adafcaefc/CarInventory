...
public class TransactionInfoForm extends IBaseForm
{
    private final TransactionData soldVehicleRecord;
    ...
    public TransactionInfoForm(TransactionData soldVehicleRecord)
    {
        super();
